...
class _LyricsMenuSheetContent extends ConsumerWidget {
  ...
  String _formatSourceLabel(String? source) {
    if (source == null || source.isEmpty) return 'No Lyrics Source';
    final s = source.toLowerCase();
    if (s == 'embedded') return 'Source: Embedded Metadata';
    if (s == 'local') return 'Source: Local Sidecar (.lrc)';
    if (s == 'custom_file') return 'Source: Custom LRC File';
    if (s == 'lrclib') return 'Source: LRCLIB';
    if (s == 'genius') return 'Source: Genius';
    if (s == 'musixmatch') return 'Source: Musixmatch';
    if (s == 'azlyrics') return 'Source: AZLyrics';
    if (s == 'lyricsmint') return 'Source: LyricsMINT';
    if (s == 'lyricfind') return 'Source: LyricFind';
    if (s == 'not_found') return 'Source: Not Found Online';
          ...
          children: [
            ...
            ListTile(
              ...
              leading: Container(
                ...
                child: const Icon(LucideIcons.sparkles, color: Colors.white70, size: 20),
              ),
              title: Text(
                'Gesture Tips',
                style: AppFonts.jostStyle(
            ...
            ListTile(
              ...
              leading: Container(
                ...
                child: const Icon(LucideIcons.download, color: Colors.white70, size: 20),
              ),
              title: Text(
            ...
            ListTile(
              ...
              leading: Container(
                ...
                child: const Icon(LucideIcons.filePlus, color: Colors.white70, size: 20),
              ),
              title: Text(

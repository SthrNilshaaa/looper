...
import 'package:looper_player/features/playback/presentation/lyrics_selection_notifier.dart';
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    selection.count == 1 ? '1 line selected' : '${selection.count} lines selected',
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    final selected = allLines.sublist(selection.startIndex!, selection.endIndex! + 1);
                    showLyricsShareSheet(context, ref, song: song, lines: selected);
                  },
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                    decoration: BoxDecoration(color: Theme.of(context).colorScheme.onSecondary, borderRadius: BorderRadius.circular(32)),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Icon(LucideIcons.share2, size: 14, color: Colors.white),

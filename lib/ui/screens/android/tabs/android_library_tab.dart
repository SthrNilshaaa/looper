            ...
            child: AppRefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(child: _buildRecentlyAccessed(context, ref)),
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildCategoryRow(
                              ...
                              onTap: () {
                                HapticFeedback.lightImpact();
                                ref.read(appNavigationProvider.notifier).setItem(NavItem.analyze);
                              },
                              isLast: true,
                            ),
                          ],
      ...
      return SizedBox(
        ...
        child: Center(
          child: Text(
            ...
            style: AppFonts.jostStyle(color: Colors.white.withValues(alpha: 0.3), fontSize: 13),
          ),
        ),
      );
    }

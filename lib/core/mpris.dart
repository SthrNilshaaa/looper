...
class MPRISPlayer extends DBusObject {
  ...
  Future<DBusMethodResponse> getProperty(String interface, String name) async {
    if (interface == 'org.mpris.MediaPlayer2') {
      switch (name) {
        ...
        case 'Identity':
          return DBusMethodSuccessResponse([DBusString('Looper Player')]);
        case 'DesktopEntry':
          return DBusMethodSuccessResponse([DBusString('looper_player')]);
      ...
      switch (name) {
        case 'PlaybackStatus':
          return DBusMethodSuccessResponse([DBusString(playbackStatus)]);
        case 'Rate':
          return DBusMethodSuccessResponse([DBusDouble(1.0)]);
        case 'Metadata':
          return DBusMethodSuccessResponse([DBusDict.stringVariant(metadata)]);
        case 'Volume':
          return DBusMethodSuccessResponse([DBusDouble(1.0)]);
        case 'Position':
          return DBusMethodSuccessResponse([DBusInt64(position)]);
        case 'MinimumRate':
          return DBusMethodSuccessResponse([DBusDouble(1.0)]);
        case 'MaximumRate':
          return DBusMethodSuccessResponse([DBusDouble(1.0)]);
  ...
  Future<void> updatePlaybackStatus(String status) async {
    ...
    await emitPropertiesChanged(
      'org.mpris.MediaPlayer2.Player',
      changedProperties: {'PlaybackStatus': DBusString(status)},
    );
  }

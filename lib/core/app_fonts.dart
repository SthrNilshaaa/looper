...
class AppFonts {
  ...
  static TextTheme adjustTextTheme(TextTheme baseTheme, int delta) {
    ...
    return baseTheme.copyWith(
      displayLarge: baseTheme.displayLarge?.copyWith(fontWeight: adjust(baseTheme.displayLarge?.fontWeight)),
      displayMedium: baseTheme.displayMedium?.copyWith(fontWeight: adjust(baseTheme.displayMedium?.fontWeight)),
      displaySmall: baseTheme.displaySmall?.copyWith(fontWeight: adjust(baseTheme.displaySmall?.fontWeight)),
      headlineLarge: baseTheme.headlineLarge?.copyWith(fontWeight: adjust(baseTheme.headlineLarge?.fontWeight)),
      headlineMedium: baseTheme.headlineMedium?.copyWith(fontWeight: adjust(baseTheme.headlineMedium?.fontWeight)),
      headlineSmall: baseTheme.headlineSmall?.copyWith(fontWeight: adjust(baseTheme.headlineSmall?.fontWeight)),
      titleLarge: baseTheme.titleLarge?.copyWith(fontWeight: adjust(baseTheme.titleLarge?.fontWeight)),
      titleMedium: baseTheme.titleMedium?.copyWith(fontWeight: adjust(baseTheme.titleMedium?.fontWeight)),
      titleSmall: baseTheme.titleSmall?.copyWith(fontWeight: adjust(baseTheme.titleSmall?.fontWeight)),
      bodyLarge: baseTheme.bodyLarge?.copyWith(fontWeight: adjust(baseTheme.bodyLarge?.fontWeight)),
      bodyMedium: baseTheme.bodyMedium?.copyWith(fontWeight: adjust(baseTheme.bodyMedium?.fontWeight)),
      bodySmall: baseTheme.bodySmall?.copyWith(fontWeight: adjust(baseTheme.bodySmall?.fontWeight)),
      labelLarge: baseTheme.labelLarge?.copyWith(fontWeight: adjust(baseTheme.labelLarge?.fontWeight)),
      labelMedium: baseTheme.labelMedium?.copyWith(fontWeight: adjust(baseTheme.labelMedium?.fontWeight)),
      labelSmall: baseTheme.labelSmall?.copyWith(fontWeight: adjust(baseTheme.labelSmall?.fontWeight)),
    );
  }

  static FontWeight get weightLight => getAdjustedWeight(FontWeight.w200, appFontWeightDelta);
  static FontWeight get weightNormal => getAdjustedWeight(FontWeight.w300, appFontWeightDelta);
  static FontWeight get weightMedium => getAdjustedWeight(FontWeight.w400, appFontWeightDelta);
  static FontWeight get weightSemiBold => getAdjustedWeight(FontWeight.w500, appFontWeightDelta);
  static FontWeight get weightBold => getAdjustedWeight(FontWeight.w700, appFontWeightDelta);
  ...
  static TextStyle jostStyle({
    ...
    if (resolvedWeight != null) {
      ...
      resolvedWeight = getAdjustedWeight(textStyle!.fontWeight!, appFontWeightDelta);
    } else {
    ...
    if (textStyle != null) {
      baseStyle = textStyle.merge(baseStyle).copyWith(fontWeight: resolvedWeight);
    }
    return baseStyle;
  }
  ...
  static TextStyle _customTextStyle({
    ...
    final isLyricsFont = fontFamily == spaceGrotesk ||
        fontFamily == sora ||

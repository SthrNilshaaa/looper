...
class LooperAnalyzeView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final topSong = snapshot.topSongs.isNotEmpty ? snapshot.topSongs.first.song : null;
          ...
          Column(
            children: [
              ...
              if (snapshot.hasHistory)
                Text(
                  '${snapshot.totalPlays} plays • ${snapshot.uniqueSongsPlayed} songs',
                  style: AppFonts.jostStyle(
  ...
  Widget build(BuildContext context) {
    final sections = <Widget>[
      ...
      if (snapshot.topArtists.isNotEmpty)
        AnalyzeTopArtistsSection(topArtists: snapshot.topArtists, accent: accent),
